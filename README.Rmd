...
###RSSApkg README
RSSApkg is designed as a suite of utility functions to aid in some common tasks
...
###Help Files
All functions contained in RSSApkg have their own help files and there is also a 
package vignette with a suggested workflow.
